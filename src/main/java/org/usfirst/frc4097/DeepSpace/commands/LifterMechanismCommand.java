 ...
 *
 */
public class LifterMechanismCommand extends Command {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
        ...
        requires(Robot.lifterMechanism);
    ...
    protected void execute() {
        ...
        double climbValue = Robot.oi.xbox.getRawAxis(1);
