...
public class LifterMechanism extends Subsystem {
    ...
    private WPI_VictorSPX victor0 = new WPI_VictorSPX(0);
    

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public LifterMechanism() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        
        addChild("victor0",victor0);
        victor0.setInverted(false);
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new LifterMechanismCommand());
